...
public class HorizontalPlatform3DComponent : InteractiveObstacleComponent
{
    ...
    public void Update()
    {
        ...
        if ( m_isClicked )
        {
            ...
            else
            {
                ...
                jointDrive.mode = JointDriveMode.Velocity;
                m_joint.xDrive = jointDrive;
                m_joint.targetVelocity = Vector3.right * ( worldPosition.x - this.transform.TransformPoint( m_initialLocalTouchPoint ).x ) * m_speedMultipler;
