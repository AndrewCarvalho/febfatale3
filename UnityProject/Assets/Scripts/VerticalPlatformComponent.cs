...
public class VerticalPlatformComponent : InteractiveObstacleComponent
{
    ...
    public void Update()
    {
        ...
        if ( m_isClicked )
        {
            ...
            else
            {
                ...
                JointMotor2D jointMotor = new JointMotor2D();
                jointMotor.motorSpeed = ( worldPosition.y - this.transform.TransformPoint( m_initialLocalTouchPoint ).y ) * m_speedMultipler;
                jointMotor.maxMotorTorque = 10000;
                m_sliderJoint.motor = jointMotor;
